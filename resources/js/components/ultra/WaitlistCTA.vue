<template>
    <section class="bg-white py-8 text-center sm:py-24">
        <div class="container mx-auto px-4">
            ...
            >
                Where awareness commands instinct — and protection transforms into orchestration.
            </h2>

            <p class="mx-auto max-w-7xl text-base font-bold text-gray-600 sm:text-xl">
                The unbreakable fusion of SteerVault™, PedalVault™, TrackVault™, and AlarmVault™ — one living defense organism.
            </p>
            <p class="mx-auto mt-4 max-w-5xl text-base text-gray-600 sm:text-lg">No gaps. No noise. Only flawless precision, always alert.</p>
            <div class="mt-8">
                <button
