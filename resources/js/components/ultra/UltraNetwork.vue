    ...
    <section class="bg-white py-8 sm:py-20">
        <div class="container mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-bold tracking-tight text-gray-900 md:text-4xl">The ULTRA Network</h2>
...
`,
    ...
    {
        title: 'Calm Security ',
        description: 'Present but never intrusive.',
...
`,
    ...
    {
        title: 'Precision-Controlled Access ',
        description: 'Biometric or App only.',
        icon: `<svg width="30" height="30" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
