<template>
    <div class="flex items-center justify-between px-8 py-3 sm:px-16">
        <h1 class="text-lg font-bold sm:text-2xl">FortiVault PRIME</h1>
        <h3 class="text-end text-sm font-bold sm:text-base">Precision in Execution.<br />Insight in Command.</h3>
    </div>
...
const slides = ref([
    { video: '/videos/Prime-video-1.mp4', text: 'FortiVault PRIME.' },
    { video: '/videos/Prime-video-2.mp4', text: 'Knows You.' },
    { video: '/videos/Prime-video-3.mp4', text: 'Blocks Everything Else.' },
    { video: '/videos/Prime-video-4.mp4', text: 'Always Alert.' },
    { video: '/videos/Prime-video-5.mp4', text: 'Intelligent Defense.' },
]);
