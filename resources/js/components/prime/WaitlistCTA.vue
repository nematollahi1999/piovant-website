<template>
    <section class="bg-white py-8 text-center sm:py-24">
        <div class="container mx-auto px-4">
            ...
            >
                The heartbeat of intelligent defense — where instinct meets foresight.
            </h2>

            <p class="mx-auto max-w-7xl text-base font-bold text-gray-600 sm:text-xl">
                A seamless fusion of SteerVault™, TrackVault™, and AlarmVault™, designed to anticipate, respond seamlessly, and safeguard with
                precision.
            </p>
            <p class="mx-auto mt-4 max-w-5xl text-base text-gray-600 sm:text-lg">It doesn’t just respond — it orchestrates.</p>
            <div class="mt-8">
                <button
