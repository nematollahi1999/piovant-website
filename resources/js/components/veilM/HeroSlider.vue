<template>
    <div class="flex items-center justify-between px-8 py-3 sm:px-16">
        <h1 class="text-lg font-bold sm:text-2xl">FortiVault Veil Manual</h1>
        <h3 class="text-end text-sm font-bold sm:text-base">Stealth Engineered. <br />Precision Concealed.</h3>
    </div>
    <div class="relative w-full text-white sm:h-[calc(100vh-40px)]">
        <swiper
                ...
                <div class="relative h-full w-full">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center p-4 text-center">
                        <h1 class="text-xl font-bold md:text-2xl lg:text-4xl">
                            <span v-if="activeIndex === index">{{ typedText }}</span>
...
const slides = ref([
    { video: '/videos/Veil-video-1.mp4', text: 'FortiVault PRIME.' },
    { video: '/videos/Veil-video-2.mp4', text: 'Knows You.' },
    { video: '/videos/Veil-video-3.mp4', text: 'Blocks Everything Else.' },
    { video: '/videos/Veil-video-4.mp4', text: 'Always Alert.' },
    { video: '/videos/Veil-video-5.mp4', text: 'Intelligent Defense.' },
    { video: '/videos/Veil-video-6.mp4', text: 'Control in your pocket.' },
]);
