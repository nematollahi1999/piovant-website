<template>
    <section class="bg-white py-8 text-center sm:py-24">
        <div class="container mx-auto px-4">
            ...
            >
                Where invisibility meets intelligence — a covert network that listens, interprets, and acts before danger appears.
            </h2>

            <p class="mx-auto max-w-7xl text-base font-bold text-gray-600 sm:text-xl">
                A seamless alliance of PedalVault™, TrackVault™, and AlarmVault™, synchronized and hidden in plain sight.
            </p>
            <p class="mx-auto mt-4 max-w-5xl text-base text-gray-600 sm:text-lg">No false triggers. No hesitation. Only silent precision.</p>
            <div class="mt-8">
                <button
